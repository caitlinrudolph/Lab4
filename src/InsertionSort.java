...
public class InsertionSort {
    ...
    public static void main(String[] args) {
        ...
        runFullExperiment("Insertion-Exp1-ThrowAway.txt");
        System.out.println("Running second full experiment...");
        runFullExperiment("Insertion-Exp2.txt");
    ...
    public static void checkSortCorrectnes()
    {
        ...
        System.out.println("Starting Insertion Sort Verify");
        System.out.println("Random List 1");
        long[] list1 = createRandomListOfIntegers(20);
        System.out.println(Arrays.toString(list1));
        long[] sortedlist1 = insertionSort(list1);
        ...
        long[] sortedlist2 = insertionSort(list2);
    ...
    public static long[] insertionSort(long[] a) {
        ...
        for (int i = 1; i < n; i++) { //inserting a[i] among a[i-1], a[1-2]...
